...
public class NpcLiLi : Npc
{
    ...
    protected override void Start()
    {
        ...
        talkContent = new Tuple<Turn, string, string, string>[] {
            new Tuple<Turn, string, string, string>(Turn.Npc, "（柜山，地面凹凸不平，丘峦层叠。走着走着，你突然被小土堆绊了一跤。小土堆里窜出一只狸力，其外貌似猪，脚上长着鸡距。狸力汪汪地朝着你叫了两声，似乎对你破坏土堆的行为很不满，狸力对你发起了攻击。）", "继续", "离开"),
            new Tuple<Turn, string, string, string>(Turn.GameStart, "", "", ""),

            new Tuple<Turn, string, string, string>(Turn.GameWin,"获取道具：畏兽之魂×1","继续","取消"),
            new Tuple<Turn, string, string, string>(Turn.End, "", "", ""),

            new Tuple<Turn, string, string, string>(Turn.GameLose, "在狸力发动必杀技的前一刻，南木护主，将你传送至了安全点。", "继续", "取消"),
            new Tuple<Turn, string, string, string>(Turn.End, "", "", ""),
